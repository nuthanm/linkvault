...
// DELETE /api/auth/account — permanently delete the account, all sessions, and all links.
export async function DELETE(req: NextRequest) {
  ...
  // Delete in dependency order: links → sessions → user
  await sql`DELETE FROM links WHERE user_id = ${sessionUser.id}`;
